...
namespace MyCustomerForms {
    ...
    public partial class CustomerDataSet : global::System.Data.DataSet {
        ...
        public partial class CustomerDataTable : global::System.Data.TypedTableBase<CustomerRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public CustomerRow AddCustomerRow(int CustomerId, string Name, string Address) {
...
namespace MyCustomerForms.CustomerDataSetTableAdapters {
    ...
    public partial class CustomerTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Customer] WHERE (([CustomerId] = @Original_CustomerId) AND ((@" +
                ...
                "Address = 1 AND [Address] IS NULL) OR ([Address] = @Original_Address)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Customer] ([CustomerId], [Name], [Address]) VALUES (@CustomerI" +
                "d, @Name, @Address);\r\nSELECT CustomerId, Name, Address FROM Customer WHERE (Cust" +
                "omerId = @CustomerId)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Customer] SET [CustomerId] = @CustomerId, [Name] = @Name, [Address] = @Address WHERE (([CustomerId] = @Original_CustomerId) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_Address = 1 AND [Address] IS NULL) OR ([Address] = @Original_Address)));
SELECT CustomerId, Name, Address FROM Customer WHERE (CustomerId = @CustomerId)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::MyCustomerForms.Properties.Settings.Default.CustomerConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT CustomerId, Name, Address FROM dbo.Customer";
        ...
        public virtual int Delete(int Original_CustomerId, string Original_Name, string Original_Address) {
        ...
        public virtual int Insert(int CustomerId, string Name, string Address) {
        ...
        public virtual int Update(int CustomerId, string Name, string Address, int Original_CustomerId, string Original_Name, string Original_Address) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Address, int Original_CustomerId, string Original_Name, string Original_Address) {
            return this.Update(Original_CustomerId, Name, Address, Original_CustomerId, Original_Name, Original_Address);
        }
    }
